  ...
  return (
    <div className={cn('p-4 sm:p-6 md:p-8 lg:p-12', className)}>
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 md:mb-10 text-center px-2">
          {title}
        </h2>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-10">
          <div className="order-2 md:order-1 space-y-4 sm:space-y-6 md:space-y-8">
            {features.map((feature, index) => (
              ...
              >
                <motion.div
                  className={cn(
                    'w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center border-2 flex-shrink-0',
          ...
          <div className="order-1 md:order-2 relative h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] overflow-hidden rounded-lg">
